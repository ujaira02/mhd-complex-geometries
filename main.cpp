...
void display_license(int width = 90) {
    ...
    std::cout << " The full text of the GPLv3 license is included in the file LICENCE-GPL3\n";
...
void display_readme(int width = 90)
{
    ...
    std::cout << "  version 3 (GPLv3). See LICENCE-GPL3 for the full text.\n";
...
int main(int argc, char** argv) {
    ...
    if (argc > 1) {
        ...
        std::cout << "  (GPLv3). See LICENCE-GPL3 for the full text.\n";
        std::cout << "\n\n";
